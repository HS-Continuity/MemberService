...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.
                authorizeHttpRequests((auth) -> auth.requestMatchers("/memberservice/api/permissions","/memberservice/access-token","/api/auth/logout","/actuator/*","/memberservice/api/member/join","/login", "/memberservice/api/auth/login", "/oauth-login/logout", "/login/oauth2/code/*","/login-fail").permitAll()
